...
a_shock_scenario <- "NGFS2021_GCAM_B2DS"
# c(
#          # "NGFS2021_REMIND_NZ2050",
#          # "NGFS2021_GCAM_B2DS",
#          # "Oxford2021_fast",
...
combined_plot <- patchwork::wrap_plots(p1, p2, ncol = 2)+
                   patchwork::plot_annotation(title = paste(a_company_name, '- scenario', a_shock_scenario))+ patchwork::plot_layout(guides = 'collect') +
