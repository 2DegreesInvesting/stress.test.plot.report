...
# 38959531-8127-4235-bcef-28177b923158 // filter(crispy.shock_scenario=="NGFS2021_MESSAGE_B2DS", crispy.shock_year==2032) 


for (run_id in c("5776a4b8-476f-48ba-91ae-b83a178d4331", "24e5ddb1-d63b-416f-bc4f-6d5f2d0e0a5f", 
                 "38959531-8127-4235-bcef-28177b923158")){
...
analysis_data_full_global_no_outlier <- analysis_data_full_global %>%
...
for (ratio_value in names(sampled_rows)){
  analysis_data_sampled <- analysis_data_full_global %>%
    inner_join(
...
```{r}
abcd_data <- abcd_toydata

analysis_data <- analysis_data_full_global %>%
  inner_join(
