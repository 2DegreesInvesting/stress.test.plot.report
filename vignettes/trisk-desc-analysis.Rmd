...
company_var_accross_scenarios <- analysis_data %>%
  filter(crispy.run_id %in% c("5776a4b8-476f-48ba-91ae-b83a178d4331", "24e5ddb1-d63b-416f-bc4f-6d5f2d0e0a5f", 
                 "663fa2de-e808-457b-b234-dca8e736b8a0", "eb594eb8-13a7-461e-b8fb-7cad52a7167b")) %>%
  group_by(
    portfolio.company_id,
    portfolio.ald_sector,
...
top_var_companies <- company_var_accross_scenarios[1:4,]$portfolio.company_id
